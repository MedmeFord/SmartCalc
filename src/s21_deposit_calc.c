...
void s21_deposit(double loan_amount, int period, double rate, int cap,
                 int period_pay, int *date) {
...
double **s21_deposit_without_cap_day(double loan_amount, int period,
                                     double rate, int cap, int period_pay,
                                     int *date) {
  int simple_year[12] = {31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31};
